...
ipv4.SetBase ("10.201.0.0", "255.255.248.0","0.0.7.35"); //this is the outer network
...
//
  ...
  csmaNetwork.EnablePcapAll ("pmuconnectiontestNet", false);
                                ...
                                std::vector<Ipv4Address> spoofedIPs{Ipv4Address ("10.201.7.40"),};
                                                                std::vector<Ipv4Address>victimIPs{Ipv4Address ("10.201.7.169"),Ipv4Address ("10.103.41.82"),Ipv4Address ("10.103.41.84"),Ipv4Address ("10.103.41.85")};
                                                                std::vector<Address>victimMACs{ns3::Mac48Address("70:b3:d5:54:22:1b"),ns3::Mac48Address("00:50:c2:4f:9a:75"),ns3::Mac48Address("00:50:c2:4f:9a:75"),ns3::Mac48Address("00:50:c2:4f:9a:75")};
                               ...
                               attacker->Setup(n0n1n2n3.Get(attackerId), dn0n1n2n3.Get(attackerId), iface, spoofedIPs, victimIPs, victimMACs);
                                ...
                                std::pair<Ptr<Ipv4>, uint32_t> returnValue2 = ipn0n1n2n3.Get (attackerId);
                                                                ...
                                                                std::vector<Ipv4Address> spoofedIPs1{Ipv4Address ("10.201.7.169"),Ipv4Address ("10.103.41.82"),Ipv4Address ("10.103.41.83"),Ipv4Address ("10.103.41.84")};
                                                                std::vector<Ipv4Address>victimIPs1{Ipv4Address ("10.201.7.40"),Ipv4Address ("10.103.40.23"),Ipv4Address ("10.103.40.23"),Ipv4Address ("10.103.40.23")};
                                                                std::vector<Address>victimMACs1{ns3::Mac48Address("04:0e:3c:25:54:40"),ns3::Mac48Address("9c:eb:e8:b2:8e:e3"),ns3::Mac48Address("9c:eb:e8:b2:8e:e3"),ns3::Mac48Address("9c:eb:e8:b2:8e:e3")};
